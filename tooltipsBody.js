export const toolTipBody {
  ...
  volumeLines: "These two lines only contain liquid ingredients, all lines on this calculator can be added by either volume or weight. The liquid lines, are the only ones that will show up on your recipe pdf as a volumetric measurements.",
  totalVolume: "This total volume is an estimate of only the fermentables in solution, your actual volume WILL be higher if using high fruit loads.",
  estimatedFg: "Unless you are planning for this mead to stop early, it is best to leave this field at .996, this estimate will be close enough for most recipes.",
  ...
  nutrientSg: "This is the difference in gravity, taking FG into account. For example, if your OG is listed as 1.100 and your FG is 1.010, this field will read 1.090. This can field can be edited.",
