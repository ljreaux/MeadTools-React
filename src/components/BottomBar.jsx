...
export default function BottomBar() {
  return (
    <div className="w-screen fixed bottom-0 left-0 text-textColor bg-sidebar md:opacity-0 hover:opacity-100 transition-all">
      <div className="w-full ">
        <span className="lg:text-5xl medium:text-3xl">
