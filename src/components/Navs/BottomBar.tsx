...
export default function BottomBar() {
  return (
    <div className=" w-screen fixed bottom-0 left-0 text-foreground">
      <div className="w-full ">
        <span className="sm:flex sm:w-full sm:justify-center">
          <div className="flex w-full sm:w-fit sm:px-4 sm:my-2 sm:rounded-2xl items-center justify-center gap-1 bg-background">
            <a
